...
#P2
#Button(p1, text='This is text on page 1', fg='blue').pack(pady=40)
texto = Label(p2,text='SHOW').place(x=10,y=5)

horizontal=0
vertical=40

btnPlotar = Button(p2, text="STANDART",command=Open_file_standart).place(x=horizontal,y=vertical)
vertical+=30
btnPlotar = Button(p2, text="PLOT", command = Plotar).place(x=horizontal,y=vertical)
vertical+=30
btnResetar = Button(p2, text="RESETAR", command = Resetar).place(x=horizontal,y=vertical)
vertical+=30
...
btnNormalizar = Button(p2, text="NORMALIZE", command = Normalizar).place(x=horizontal,y=vertical)
vertical+=30
##################################polinomios
p=9
w=11
...
xc = Label(p2, text = "Pol")
xc.place(bordermode = OUTSIDE, height = 30, width = 30, x =horizontal_2,y=vertical )
horizontal_2+=20
pbB = Entry(p2, textvariable = p)
pbB.place(bordermode = OUTSIDE, height = 30, width = 40, x = horizontal_2, y =vertical )
horizontal_2+=40
xd = Label(p2, text = "Win")
xd.place(bordermode = OUTSIDE, height = 30, width = 30, x =horizontal_2,y=vertical )
horizontal_2+=30
wcC = Entry(p2, textvariable = w)
wcC.place(bordermode = OUTSIDE, height = 30, width = 40, x = horizontal_2, y =vertical )
...
btnNormalizar = Button(p2, text="SMOOTH", command = Suavizar).place(x=horizontal,y=vertical)
vertical+=30
btnCentralizar = Button(p2, text="CENTRALIZE", command = Centralizar).place(x=horizontal,y=vertical)
vertical+=30
btnCentralizar = Button(p2, text="LORENTZPOLARIZATION",state=NORMAL,command = LorentxPolarization).place(x=horizontal,y=vertical)
vertical+=30
btnCentralizar = Button(p2, text="BACKGROUND",command = Background).place(x=horizontal,y=vertical)

pback=20
horizontal_2=210
xc = Label(p2, text = "size")
xc.place(bordermode = OUTSIDE, height = 30, width = 40, x =horizontal_2,y=vertical )
horizontal_2+=30
pbBack = Entry(p2, textvariable = pback)
pbBack.place(bordermode = OUTSIDE, height = 30, width = 40, x = horizontal_2, y =vertical )
...
a=int
b=int
xc = Label(p2, text = "Min")
xc.place(bordermode = OUTSIDE, height = 30, width = 30, x =0,y=ak )

bB = Entry(p2, textvariable = a)
bB.place(bordermode = OUTSIDE, height = 30, width = 40, x = 30, y =ak )

xd = Label(p2, text = "Max")
xd.place(bordermode = OUTSIDE, height = 30, width = 30, x =70,y=ak )

cC = Entry(p2, textvariable = b)
cC.place(bordermode = OUTSIDE, height = 30, width = 50, x = 100, y =ak )


#P3

texto = Label(p3,text='ANALYSIS').place(x=360,y=5)
